        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="relative group cursor-pointer">
              ...
              <span className="absolute -top-1.5 -right-1.5 bg-white text-black text-[8px] font-black w-3.5 h-3.5 flex items-center justify-center rounded-full">0</span>
            </div>
          </div>
        </div>
      </nav>
           ...
           <div className="flex gap-4 overflow-x-auto scrollbar-hide pb-2">
              {displayImages.map((img, idx) => (
                <button 
                  ...
                  className={`flex-shrink-0 w-16 h-20 bg-[#0a0a0a] border-b-2 transition-all duration-300 ${
                    selectedImage === idx ? "border-white opacity-100" : "border-transparent opacity-30 hover:opacity-100"
                  }`}
                >
        ...
        <div className="flex flex-col">
                   ...
                   <div className="flex flex-wrap gap-3">
                      {values.map(val => (
                        <button
                          ...
                          className={`min-w-[4rem] h-12 px-6 text-[10px] font-black uppercase tracking-widest transition-all border ${
           ...
           <div className="space-y-4 pb-12">
              <div className="grid grid-cols-2 gap-4">
                ...
                <button className="h-14 bg-transparent border border-white/20 text-white/60 text-[10px] font-black uppercase tracking-[0.3em] transition-all hover:bg-white/5 hover:text-white hover:border-white">
                  Add to Bag
                </button>
              </div>
           </div>
